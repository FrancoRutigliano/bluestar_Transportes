...
export const Header = () => {
 ...
 <div className="relative w-full h-screen overflow-hidden">
  ...
  <div className="absolute top-48 left-4 flex flex-col text-white items-start  z-10 " >
    <h1 className="text-3xl font-inter leading-snug font-bold " style={{ textShadow: '2px 2px 10px black' }}>Transporte <br /> seguro <br /> y eficiente</h1>
    <p className="text-sm  w-2/3 mt-5 ">Tenemos más de 25 años de experiencia. Somos una pyme, y nuestra flota cuenta con con chasis y semis tipo saider. Llevamos volumen y poco peso. Contamos con chasis de 5 y 10 mil kilos y semis de 15 y 22 mil kilos.</p>

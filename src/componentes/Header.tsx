...
export const Header = () => {
 ...
 <div className="relative w-full h-screen overflow-hidden">
  ...
  />
  <div className="absolute inset-0 bg-gradient-to-t from-azul to-transparent"></div>
  <div className="absolute top-48 lg:top-42 left-4 lg:left-8 flex flex-col text-white items-start  z-10 " >
    <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-inter leading-snug sm:leading-normal  font-bold " style={{ textShadow: '2px 2px 10px black' }}>Transporte <span className='block sm:inline'> seguro </span>  <span className='sm:block'>y eficiente</span></h1>
